window.ClaraCoreTranslations = {
  ...
  zh: {
    ...
    "innerLife.history": "历史",
    "innerLife.historyEmpty": "还没有内部变化历史。",
    "innerLife.experiences": "经历",
    ...
    "data.oldContinuitySummary": "{lines} 条线，{positions} 条接续进展，{handoffs} 条交接",
