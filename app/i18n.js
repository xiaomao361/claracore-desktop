window.ClaraCoreTranslations = {
  en: {
    ...
    "agentSetup.body": "One agent-friendly setup surface for MCP config, CLI fallback notes, runtime paths, and recent Gateway activity.",
  ...
  zh: {
    ...
    "agentSetup.body": "一个面向 agent 的接入页面，集中放 MCP 配置、CLI 备用说明、运行路径和 Gateway 活动。",
