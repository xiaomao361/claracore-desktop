window.ClaraCoreTranslations = {
  ...
  zh: {
    ...
    "view.agentSetup.title": "Agent 接入",
    "view.agentSetup.subtitle": "连接外部 agent 的第一入口。",
    ...
    "home.trace.openConnections": "打开 Agent 接入",
    ...
    "logs.follow": "跟随",
    "logs.clear": "清理",
    "logs.clearConfirm": "清理运行事件和 Gateway 轨迹？",
    "logs.cleared": "日志已清理（运行 {runtime}，Gateway {gateway}）",
    ...
    "innerLife.daemonControlHint": "本地循环由人控制；内容由 Agent 管理。",
    ...
    "innerLife.agentOwned": "由 Agent 管理",
    ...
    "connections.auth.bearer": "Bearer token",
    "connections.endpoint.agent-setup-json": "Agent 接入 JSON",
    "connections.endpoint.gateway-context-json": "Gateway 上下文 JSON",
    "connections.endpoint.gateway-web": "Gateway 控制台",
    "connections.endpoint.memoria-web": "Memoria",
    "connections.endpoint.continuity-web": "Continuity",
    "connections.endpoint.innerlife-web": "InnerLife",
    "connections.noEndpoints": "本机 HTTP Agent Gateway 正在启动。",
    "agentSetup.title": "Agent 接入",
    "agentSetup.body": "面向 agent 优先的接入页面，集中放 MCP 配置、连接方式、CLI 备用说明、运行路径和 Gateway 活动。",
    "agentSetup.actions": "操作",
    "agentSetup.copy": "复制接入说明",
    "agentSetup.connectionMode": "连接方式",
    "agentSetup.modeMcp": "当前推荐：把 stdio MCP 配置复制到 agent 客户端。",
    "agentSetup.modeLan": "本机 URL 已可用：Desktop 会暴露带 token 的 localhost HTTP Agent Gateway。局域网绑定默认关闭，除非明确启用。",
