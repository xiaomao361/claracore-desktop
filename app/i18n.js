window.ClaraCoreTranslations = {
  en: {
    ...
    "agentSetup.body": "Give this brief to each agent so it can install ClaraCore access with its own identity.",
  ...
  zh: {
    ...
    "agentSetup.body": "把这份说明交给每个智能体，让它用自己的身份安装 ClaraCore 接入。",
