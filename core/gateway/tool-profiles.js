...
const CORE_TOOL_SHAPES = Object.freeze({
  claracore_status: {
    description: "Read product data status."
  },
  ...
  gateway_context: {
    description:
      "One assembled packet from Memory, Shared Line, and InnerLife. Start with detail=brief and no lineId; SHARED_LINE_ID_REQUIRED means several active lines, so retry with one candidate."
  },
  ...
  memoria_link_list: {
    description: "List Memory links for one Memory or kind. Read before adding more.",
    properties: ["memoryId", "kind", "limit"]
  },
  ...
  memoria_record_list: {
    description: "List typed structured records.",
    properties: ["userId", "recordType", "localDate", "start", "end", "limit"]
  },
  shared_line_list: {
    description: "List Shared Lines and identify the active one. Pass status to narrow."
  },
  shared_line_get: {
    description:
  ...
  innerlife_share_check: {
    description:
      "Does a waiting share fit here? Pass real conversation context, not keywords.",
