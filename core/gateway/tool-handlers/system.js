      ...
      content: [
        {
          ...
          text: [
            ...
            "",
            "### Observe automatic Memory retrieval",
            "",
            "1. Call memory_context with the current user prompt when the host is evaluating automatic recall.",
            "2. Slice 1 is observe-only: inspect action, reason, candidates, timing, and decisionId, but expect an empty context.",
            "3. Use explicit memoria_search for user-requested research, maintenance, audit, or historical comparison.",
            "",
