      ...
      content: [
        {
          ...
          text: [
            ...
            "- Start resume reads with gateway_context. If it returns multiple candidates, retry with the intended lineId; use shared_line_list when you need the full catalog or are preparing a write.",
