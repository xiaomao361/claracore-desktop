...
- Memory graph loads only when the Graph tab is opened.
...
| Memory graph canvas animation | `app/views/memoria.js` | cancel before scheduling the next frame or when replacing graph state |
