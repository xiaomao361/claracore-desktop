# Archived Version History Through v0.5.6

This file preserves the former long-form checkpoint log. It is historical
evidence, not the current branching or release contract. See
`../VERSION_BRANCHING.md` for current rules.
